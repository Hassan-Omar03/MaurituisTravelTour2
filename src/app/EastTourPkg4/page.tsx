...
<div className="grid md:grid-cols-2 gap-6 mb-10 justify-center">
  ...
  <div className="bg-gray-500/80 ring-1 ring-white/30 backdrop-blur-sm rounded-2xl sm:p-6 p-2 text-left shadow-md w-full max-w-[520px] mx-auto">
    ...
    <ul className="space-y-2 text-gray-200 text-lg leading-relaxed">
      <li>• Group shared boat catamaran or speed boat</li>
      <li>• Private Boat (Start 9:00 o clock till 3:30 to 4).</li>
        <li>• Snorkeling at Ile aux Cerfs.</li>
        <li>• Visit the Grand River South East Waterfall.</li>
        <li>• Visit the beautiful lagoon of Ile aux Cerfs.</li>
        <li>• Free time to relax on the beach or explore the island.</li>
        <li>• Lunch at a local restaurant (own expense).</li>
      <li>• Visit the Flacq market.</li>
