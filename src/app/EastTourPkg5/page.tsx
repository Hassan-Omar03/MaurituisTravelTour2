...
<div className="grid md:grid-cols-2 gap-6 mb-10 justify-center">
  ...
  <div className="bg-gray-500/80 ring-1 ring-white/30 backdrop-blur-sm rounded-2xl sm:p-6 p-2 text-left shadow-md w-full max-w-[520px] mx-auto">
    ...
    <ul className="space-y-2 text-gray-200 text-lg leading-relaxed">
      <li>• Parachute signle or double</li>
      <li>• Tube ride Single | Double | Triple.</li>
      <li>• Under sea walk.</li>
        <li>• Submarine ride.</li>
        <li>• Glass bottom boat ride.</li>
        <li>• Snorkeling equipment provided.</li>
        <li>• Lunch at a local restaurant (own expense).</li>
  ...
  {[
    {
      ...
      desc: "Sea activities in Mauritius offer a perfect mix of excitement and relaxation, set against crystal-clear lagoons and vibrant marine life. From gliding over turquoise waters to exploring colorful reefs below, each experience captures the island’s playful spirit and tropical charm.",
    },
