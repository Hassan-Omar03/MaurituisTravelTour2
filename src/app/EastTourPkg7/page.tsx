...
<div className="grid md:grid-cols-2 gap-6 mb-10 justify-center">
  ...
  <div className="bg-gray-500/80 ring-1 ring-white/30 backdrop-blur-sm rounded-2xl sm:p-6 p-2 text-left shadow-md w-full max-w-[520px] mx-auto">
    ...
    <ul className="space-y-2 text-gray-200 text-lg leading-relaxed">
      <li>• Private boat and lunch included (Maurituis bar b que)</li>
      <li>• Île aux Cerfs.</li>
      <li>• Visit the famous Grand River South East Waterfall.</li>
    <li>• Chance to spot monkeys near the river banks.</li>
    <li>• Crystal clear water and lush green surroundings.</li>
    <li>• White sandy beaches and turquoise lagoon.</li>
    <li>• Relaxation, swimming, and photo opportunities.</li>
    </ul>
  </div>
...
<div className="flex max-w-[1300px] w-[90%] mx-auto flex-wrap justify-center items-center gap-6  pb-10 bg-white">
  {[
    {
      img: "/81.jpg",
      title: "Grand River South East Waterfall",
