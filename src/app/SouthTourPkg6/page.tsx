...
<div className="grid md:grid-cols-2 gap-6 mb-10 justify-center">
  ...
  <div className="bg-gray-500/80 ring-1 ring-white/30 backdrop-blur-sm rounded-2xl sm:p-6 p-2 text-left shadow-md w-full max-w-[520px] mx-auto">
    ...
    <ul className="space-y-2 text-gray-200 text-lg leading-relaxed">
      <li>• Hindu Temple.</li>
      <li>• The sacred lake of Hindu Pilgrimage.</li>
      <li>• Dedicated mainly to Lord Shiva.</li>
      <li>• Famous for Maha Shivaratri festival.</li>
      <li>• Pilgrims walk barefoot to this holy site.</li>
      <li>• Giant statue of Lord Shiva at the entrance.</li>
      <li>• Surrounded by peaceful mountains and forest.</li>
    </ul>
  </div>
